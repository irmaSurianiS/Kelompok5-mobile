package com.azhar.registrasi.view.regis
...
import com.azhar.registrasi.BuildConfig
import com.azhar.registrasi.R
import com.azhar.registrasi.utils.BitmapManager.bitmapToBase64
import com.azhar.registrasi.viewmodel.RegisViewModel
...
class RegisActivity : AppCompatActivity() {
    ...
    lateinit var absenViewModel: RegisViewModel
        ...
        fusedLocationClient.lastLocation
            .addOnSuccessListener(this) { location ->
                ...
                if (location != null) {
                    ...
                    val geocoder = Geocoder(this@RegisActivity, Locale.getDefault())
                    try {
                        val addressList =
                    ...
                    progressDialog.dismiss()
                    Toast.makeText(this@RegisActivity,
    ...
    private fun setInitLayout() {
        ...
        absenViewModel = ViewModelProvider(this, (ViewModelProvider.AndroidViewModelFactory
                .getInstance(this.application) as ViewModelProvider.Factory)).get(RegisViewModel::class.java)
        ...
        layoutImage.setOnClickListener {
            Dexter.withContext(this@RegisActivity)
                .withPermissions(
